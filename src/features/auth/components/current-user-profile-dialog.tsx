...
interface CurrentUserProfileDialogProps {
  open: boolean
...
export function CurrentUserProfileDialog({
  open,
  onOpenChange,
}: CurrentUserProfileDialogProps) {
  const currentUserQuery = useQuery({
    queryKey: ["auth", "profile-dialog"],
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl">
        <DialogHeader>
          ...
          <DialogDescription>查看当前登录账号的身份信息与基础资料。</DialogDescription>
        </DialogHeader>
